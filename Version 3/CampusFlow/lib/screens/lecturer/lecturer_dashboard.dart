...
class _LecturerDashboardState extends State<LecturerDashboard> {
  ...
  int _studentCount = 0;
  int _courseCount = 0;
  final double _averageAttendance = 0;
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      // ✅ DEBUG: debugPrint user info
      debugPrint('🔍 Lecturer Dashboard - User UID: ${user.uid}');
      debugPrint('🔍 Lecturer Dashboard - User Email: ${user.email}');
      ...
      debugPrint('🔍 Lecturer document exists: ${doc.exists}');

      if (doc.exists) {
        final data = doc.data() as Map<String, dynamic>;

        // ✅ DEBUG: debugPrint all data
        debugPrint('📊 Lecturer data: $data');
        ...
        try {
          ...
          debugPrint('📊 Student count: $_studentCount');
        } catch (e) {
          debugPrint('⚠️ Error getting student count: $e');
          _studentCount = 0;
        }
        ...
        try {
          ...
          debugPrint('⚠️ Error loading attendance: $e');
          _recentActivities = [];
        }
      } else {
